...
import '../core/audio_waveform.dart';
import 'active_waveform_painter.dart';
import 'inactive_waveform_painter.dart';
  ...
  RectangleWaveform({
    ...
    bool invert = false,
        ...
        super(
          ...
          maxDuration: maxDuration,
          elapsedDuration:
              elapsedDuration > maxDuration ? maxDuration : elapsedDuration,
